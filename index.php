...
<body>
		    ...
		    <div class="section-card" style="padding: 36px 0px">
		    	<div class="row">
		    		<div class="col s6">
			    		...
			    		<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP. Sistem ini dibuat sebagai Ujian Akhir Semester Mata Kuliah Sistem Pendukung Keputusan Prodi Teknik Informatika Politeknik Harapan Bersama Tegal. </p>
						</div>
			    	<div class="col s6">
    ...
    <div class="modal-content">
      ...
      <p>Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP.
				Sistem ini dibuat sebagai Ujian Akhir Semester Mata Kuliah Sistem Pendukung Keputusan Prodi Teknik Informatika Politeknik Harapan Bersama Tegal. <br>
				<br>
			</p>
    </div>
	...
	<div class="footer-copyright" style="padding: 0px 0px">
      <div class="container">
        <p align="center" style="color: #999">&copy; Sistem Pendukung Keputusan Pemilihan Smartphone 2021.</p>
      </div>
    </div>
    <!-- Footer End -->

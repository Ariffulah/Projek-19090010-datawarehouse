                                ...
                                <div class="col s6">      
                                    <div class="card">
                                        <div class="card-content">
                                            <div class="row">
                                                <center><h4> Hasil Rekomendasi </h4></center>
                                                <br>
                                                        ...
                                                        <div class="col s12">
                                                            ...
                                                            <div class="col s6">
                                                                <select required name="chipset">
                                                                    ...
                                                                    <option value = "3">MediaTek</option>
                                                                    <option value = "4">Exynos</option>
                                                                    <option value = "5">Snapdragon</option>
                                                                </select>
                                                            </div>
	...
	<div id="about" class="modal">
        <div class="modal-content">
          ...
          <p>Sistem Pendukung Keputusan Pemilihan Smartphone ini menggunakan metode TOPSIS yang dibangun menggunakan bahasa PHP.
				Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Teknik Informatika Politeknik Harapan Bersama Tegal. <br>
				<br>
			</p>
        </div>

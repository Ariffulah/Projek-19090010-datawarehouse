...
<?php 
	if(isset($_POST["tambah_hp"])){
		...
		$ram       = $_POST["ram"];
		$memori    = $_POST["memori"];
		$chipset   = $_POST["processor"];
		$kamera    = $_POST["kamera"];
		
		$harga_angka = $ram_angka = $memori_angka = $chipset_angka = $kamera_angka = 0;
		...
		elseif($chipset == "MediaTek"){
			$processor_angka = 3;
		}
		elseif($processor == "Exynos"){
			$processor_angka = 4;
		}
		elseif($processor == "Snapdragon"){
			$processor_angka = 5;
		}
									...
									<table id="table_id" class="hover dataTablesCustom" style="width:100%">
											<thead style="border-top: 1px solid #d0d0d0;">
												<tr>
													...
													<th><center>Chipset HP</center></th>
